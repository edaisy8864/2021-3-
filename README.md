...
|REQ|Type|Priority|Content|
|:---:|:---:|:---:|:---|
|135|FR|4|시스템은 Customer가 마우스의 클릭을 사용하여 "메인메뉴" 탭, "사이드메뉴" 탭, "음료 및 디저트 메뉴" 탭, "서비스" 탭, "공지사항" 탭, "주문완료" 탭을 선택할 수 있게 허용해야 한다.|
|135|FR|4|시스템은 Customer가 각 탭에 포함된 다양한 "메뉴" 버튼들을 마우스의 클릭을 사용하여 선택할 수 있게 허용해야 한다.
|135|FR|4|시스템은 Customer가 "메뉴" 버튼들을 선택했을 때 장바구니 목록에 해당 메뉴를 추가해야 한다.|
|135|FR|4|시스템은 Customer가 장바구니 목록에 담긴 메뉴의 개수를 조절할 수 있도록 각 항목 우측에 달린 "+"와 "-" 버튼을 마우스의 클릭을 사용하여 선택할 수 있게 허용해야 한다.|
|135|FR|4|시스템은 Customer가 장바구니 목록에 담긴 메뉴를 삭제할 수 있도록 각 항목 좌측에 달린 "X" 버튼을 마우스의 클릭을 사용하여 선택할 수 있게 허용해야 한다.|
|135|FR|4|시스템은 Customer가 장바구니 목록에 담긴 메뉴를 주문할 수 있도록 장바구니 하단의 "주문하기" 버튼을 마우스의 클릭을 사용하여 선택할 수 있게 허용해야 한다.|
|135|FR|4|시스템은 Customer가 Customer 모드로 되돌아갈 수 있도록 장바구니 하단의 "홈으로" 버튼을 마우스의 클릭을 사용하여 선택할 수 있게 허용해야 한다.|
