...
|38|FR|4|시스템은 "등록된 아이디" 라디오 버튼과 "비밀번호 변경하기" 버튼이 활성화 됬을 때 Admin이 마우스 클릭을 사용하여 이를 선택할 수 있게 허용해야 한다.|
...
|45|NFR|5|시스템은 인증번호의 일치를 확인했을 때 “등록된 아이디” 라디오 버튼과 “비밀번호 변경하기” 버튼을 활성화하여 화면에 보여주어야 한다.|
