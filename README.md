...
|8|FR|3|시스템은 Admin이 “회원가입” 버튼을 선택하면 <Admin 회원가입> 화면으로 이동해야 한다.
|9|FR|3|시스템은 “아이디/비밀번호 찾기” 버튼을 선택하면 <Admin 아이디/비밀번호 찾기> 화면으로 이동해야 한다.
|10|NFR|5|시스템을 실행했을 때 시스템은 “아이디” 텍스트 상자, “비밀번호” 텍스트 상자, “로그인” 버튼, “회원가입” 버튼, “아이디/비밀번호 찾기” 버튼을 <Admin 로그인> 화면에 보여주어 Admin이 아이디와 비밀번호를 입력할 수 있어야야 한다.|
...
|REQ|Type|Priority|Content|
|:---:|:---:|:---:|:---|
|11|FR|4|시스템은 <Admin 회원가입> 화면에서 Admin이 화면을 터치하여 “아이디” 텍스트 상자, “비밀번호” 텍스트 상자, “비밀번호 재확인” 텍스트 상자, “이메일” 텍스트 상자를 선택할 수 있게 허용해야 한다.|
...
|REQ|Type|Priority|Content|
|:---:|:---:|:---:|:---|
|30|FR|4|시스템은 <Admin 아이디/비밀번호 찾기> 화면에서 Admin이 화면을 터치하여 “등록된 이메일” 텍스트 상자를 선택한 후 키보드를 사용하여 이메일을 입력할 수 있게 허용해야 한다.|
